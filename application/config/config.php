...
//Setingan Database
$config['database_host']	= 'mbangun.id';
$config['database_user']	= 'dev';
$config['database_pass'] 	= 'dev@2020';
...
$config['web_title']		= "CV. Sumber Sepeda Baru";
$config['web_footer']		= $config['web_title']." &copy; 2021.";
