<?php echo form_open('barang/tambah', array('id' => 'submit')); ?>
<div class='table-responsive'>
	<table class='table table-bordered table-wrapper' id='TabelTambahBarang'>
		<thead>
			<tr>
				<th>#</th>
				<th>Kode Barang</th>
...
<script>
	...
	function BarisBaru() {
		...
		Baris += "<td><input type='file' name='foto[]' class='form-control input-sm'></td>";
		Baris += "<td><input type='file' name='foto[]' class='form-control input-sm'></td>";
		Baris += "<td><input type='file' name='foto[]' class='form-control input-sm'></td>";
		Baris += "<td><input type='file' name='foto[]' class='form-control input-sm'></td>";
